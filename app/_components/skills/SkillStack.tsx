...
export default function SkillStack({}: Props) {
  return (
    <div className="snap-start w-full h-screen bg-gradient-to-tr from-red-100 from-0% via-orange-100 to-yellow-100 dark:from-red-800 dark:from-0% dark:via-orange-800 dark:to-yellow-800">
      <div
        className={cn(
